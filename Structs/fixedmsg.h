...
enum
{
    ...
    ITEMDESC_PHY_PENETRATION = 397,
    ITEMDESC_ALLMAGIC_PENETRATION,

    ITEMDESC_ALEATORY1 = 410,
    ITEMDESC_ALEATORY2,

    ITEMDESC_CRISTALLUAR_ESCARLATE = 435,
    ITEMDESC_CRISTALLUAR_VERDEJANTE,
    ITEMDESC_CRISTALLUAR_CERULEO,
    ITEMDESC_CRISTALLUAR_VIOLETA,
    ITEMDESC_CRISTALLUAR_AMARELO,

    ITEMDESC_MAIORNIVEL = 453,
